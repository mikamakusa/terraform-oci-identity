...
resource "oci_identity_authentication_policy" "this" {
  ...
  compartment_id = element(oci_identity_compartment.this.*.id, lookup(var.authentication_policy[count.index], "compartment_id"))
...
resource "oci_identity_auth_token" "this" {
  ...
  user_id     = element(oci_identity_user.this.*.id, lookup(var.auth_token[count.index], "user_id"))
...
resource "oci_identity_customer_secret_key" "this" {
  ...
  user_id      = element(oci_identity_user.this.*.id, lookup(var.customer_secret_key[count.index], "user_id"))
}
...
resource "oci_identity_db_credential" "this" {
  ...
  user_id     = element(oci_identity_user.this.*.id, lookup(var.db_credential[count.index], "user_id"))
}

resource "oci_identity_domain" "this" {
  count                     = length(var.compartment) == 0 ? 0 : length(var.domain)
  compartment_id            = element(oci_identity_compartment.this.*.id, lookup(var.domain[count.index], "compartment_id"))
...
resource "oci_identity_domain_replication_to_region" "this" {
  ...
  domain_id      = element(oci_identity_domain.this.*.id, lookup(var.domain_replication_to_region[count.index], "domain_id"))
...
resource "oci_identity_dynamic_group" "this" {
  ...
  compartment_id = element(oci_identity_compartment.this.*.id, lookup(var.dynamic_group[count.index], "compartment_id"))
...
resource "oci_identity_group" "this" {
  ...
  compartment_id = element(oci_identity_compartment.this.*.id, lookup(var.group[count.index], "compartment_id"))
...
resource "oci_identity_identity_provider" "this" {
  ...
  compartment_id      = element(oci_identity_compartment.this.*.id, lookup(var.identity_provider[count.index], "compartment_id"))
...
resource "oci_identity_idp_group_mapping" "this" {
  count                = length(var.group) == 0 ? 0 : length(var.idp_group_mapping)
  group_id             = element(oci_identity_group.this.*.id, lookup(var.idp_group_mapping[count.index], "group_id"))
  identity_provider_id = element(oci_identity_identity_provider.this.*.id, lookup(var.idp_group_mapping[count.index], "identity_provider_id"))
...
resource "oci_identity_import_standard_tags_management" "this" {
  ...
  compartment_id              = element(oci_identity_compartment.this.*.id, lookup(var.import_standard_tags_management[count.index], "compartment_id"))
...
resource "oci_identity_network_source" "this" {
  ...
  compartment_id     = element(oci_identity_compartment.this.*.id, lookup(var.network_source[count.index], "compartment_id"))
...
resource "oci_identity_policy" "this" {
  ...
  compartment_id = element(oci_identity_compartment.this.*.id, lookup(var.policy[count.index], "compartment_id"))
...
resource "oci_identity_smtp_credential" "this" {
  ...
  user_id     = element(oci_identity_user.this.*.id, lookup(var.smtp_credential[count.index], "user_id"))
}
...
resource "oci_identity_tag" "this" {
  ...
  tag_namespace_id = element(oci_identity_tag_namespace.this.*.id, lookup(var.tag[count.index], "tag_namespace_id"))
  ...
  dynamic "validator" {
    for_each = lookup(var.tag[count.index], "validator") == null ? [] : ["validator"]
    content {
...
resource "oci_identity_tag_default" "this" {
  count             = (length(var.compartment)) == 0 ? 0 : length(var.tag_default)
  compartment_id    = element(oci_identity_compartment.this.*.id, lookup(var.tag_default[count.index], "compartment_id"))
  tag_definition_id = element(oci_identity_tag_default.this.*.tag_definition_id, lookup(var.tag_default[count.index], "tag_definition_id"))
...
resource "oci_identity_tag_namespace" "this" {
  ...
  compartment_id = element(oci_identity_compartment.this.*.compartment_id, lookup(var.tag_namespace[count.index], "compartment_id"))
...
resource "oci_identity_ui_password" "this" {
  ...
  user_id = element(oci_identity_user.this.*.id, lookup(var.ui_password[count.index], "user_id"))
}
...
resource "oci_identity_user_capabilities_management" "this" {
  ...
  user_id                      = element(oci_identity_user.this.*.id, lookup(var.user_capabilities_management[count.index], "user_id"))
...
resource "oci_identity_user_group_membership" "this" {
  count    = (length(var.group)) == 0 ? 0 : length(var.user_group_membership)
  group_id = element(oci_identity_group.this.*.id, lookup(var.user_group_membership[count.index], "group_id"))
  user_id  = element(oci_identity_user.this.*.id, lookup(var.user_group_membership[count.index], "user_id"))
}